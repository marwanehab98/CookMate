...
export default function SearchBar() {
    ...
    return (
        <div className="max-w w-1/2 mx-auto">
            <form onSubmit={() => router.push(`/search/${query}`)}>
                ...
                <div className="relative">
                    ...
                    <input type="search" onChange={(e) => setQuery(e.target.value)} id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Recipes" required />
